...
const monday = 1
const firstDayOfTheWeek = parseInt(window.Traffic_Forecast.start_of_week, 10) || monday

export default [
  {
    key: 'custom',
    label: __('Custom', 'Traffic-Forecast')
  },
  {
    key: 'today',
    label: __('Today', 'Traffic-Forecast'),
    dates: () => {
  ...
  {
    key: 'yesterday',
    label: __('Yesterday', 'Traffic-Forecast'),
    dates: () => {
  ...
  {
    key: 'this_week',
    label: __('This week', 'Traffic-Forecast'),
    dates: () => {
      const now = new Date()
  ...
  {
    key: 'last_week',
    label: __('Last week', 'Traffic-Forecast'),
    dates: () => {
  ...
  {
    key: 'last_28_days',
    label: __('Last 28 days', 'Traffic-Forecast'),
    dates: () => {
      const today = new Date()
  ...
  {
    key: 'this_month',
    label: __('This month', 'Traffic-Forecast'),
    dates: () => {
      const today = new Date()
  ...
  {
    key: 'last_month',
    label: __('Last month', 'Traffic-Forecast'),
    dates: () => {
      const today = new Date()
  ...
  {
    key: 'this_quarter',
    label: __('This quarter', 'Traffic-Forecast'),
    dates: () => {
      const today = new Date()
  ...
  {
    key: 'last_quarter',
    label: __('Last quarter', 'Traffic-Forecast'),
    dates: () => {
      const today = new Date()
  ...
  {
    key: 'this_year',
    label: __('This year', 'Traffic-Forecast'),
    dates: () => {
      const today = new Date()
  ...
  {
    key: 'last_year',
    label: __('Last year', 'Traffic-Forecast'),
    dates: () => {
      const today = new Date()
