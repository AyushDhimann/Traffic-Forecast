  ...
  render () {
    ...
    return (
      <div className='totals-container'>
        <div className='totals-box Traffic-fade' key={hash + '-visitors'}>
          <div className='totals-label'>{__('Total visitors', 'Traffic-Forecast')}</div>
          ...
          <div className='totals-compare'>
            <span>{numbers.formatPretty(Math.abs(visitorsDiff))} {visitorsDiff > 0 ? __('more than previous period', 'Traffic-Forecast') : __('less than previous period', 'Traffic-Forecast')}</span>
          </div>
        </div>
        <div className='totals-box Traffic-fade' key={hash + '-pageviews'}>
          <div className='totals-label'>{__('Total pageviews', 'Traffic-Forecast')}</div>
          ...
          <div className='totals-compare'>
            <span>{numbers.formatPretty(Math.abs(pageviewsDiff))} {pageviewsDiff > 0 ? __('more than previous period', 'Traffic-Forecast') : __('less than previous period', 'Traffic-Forecast')}</span>
          </div>
        </div>
        <Realtime />
      </div>
