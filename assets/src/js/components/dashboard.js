    ...
    return (
      <main>
        <div>
          ...
          <div>
            <iframe id="tableau-viz" src="https://10ax.online.tableau.com/t/trailblazers/views/qwertyui/Sheet1?:origin=card_share_link&:embed=y" width="800" height="500" hide-tabs="" toolbar="bottom"></iframe>
          </div>
          <div className='grid'>
          ...
          <div>
            <span className={'description right'}>{__('Tip: use the arrow keys to quickly cycle through date ranges.', 'Traffic-Forecast')}</span>
          </div>
        </div>
      </main>
    )
