    ...
    return (
      <div className='box Traffic-fade top-posts'>
        ...
        <div className='body'>
          ...
          {items.length === 0 && (
            <div className='box-grid'>{__('There\'s nothing here, yet!', 'Traffic-Forecast')}</div>)}
        </div>
      </div>
    )
  }
