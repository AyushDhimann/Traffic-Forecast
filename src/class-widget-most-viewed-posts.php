...
class Widget_Most_Viewed_Posts extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description'                 => esc_html__( 'Your site&#8217;s most viewed posts, as counted by Traffic Forecast.', 'Traffic-Forecast' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'Traffic-Forecast-most-viewed-posts', 'Traffic Forecast: ' . esc_html__( 'Most viewed posts', 'Traffic-Forecast' ), $widget_ops );
		$this->alt_option_name = 'widget_Traffic_Forecast_most_viewed_posts';
	}

	private function get_default_settings() {
		return array(
			'title'     => esc_html__( 'Most viewed posts', 'Traffic-Forecast' ),
			'number'    => 5,
			'post_type' => 'post',
			'show_date' => false,
			'days'    => 30,
	...
	public function form( $settings ) {
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>" style="display: block;"><?php echo esc_html__( 'Title:', 'Traffic-Forecast' ); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $settings['title'] ); ?>" />
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'post_type' ); ?>" style="display: block;"><?php echo esc_html__( 'Post type:', 'Traffic-Forecast' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'days' ); ?>" style="display: block;"><?php echo esc_html__( 'Number of days to use statistics for:', 'Traffic-Forecast' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>" style="display: block;"><?php echo esc_html__( 'Number of posts to show:', 'Traffic-Forecast' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'show_date' ); ?>"><?php echo esc_html__( 'Display post date?', 'Traffic-Forecast' ); ?></label>
		</p>
		<?php
	}
}
